...
Kontaktinformation längst ner: Längst ner finns företagets kontaktuppgifter, som inkluderar adress, telefonnummer och e-post. Denna placering gör det lättillgängligt för användaren att hitta all kontaktinformation på ett och samma ställe, utan att behöva leta genom sidan. Jag skapade med flex-böx. Layouten är resonsive genom användering av flex box-egenskaper. jag har även lagt till en media query för att alla element alltid ska placeras i mitten, oavsett skärmstorlek.  
